...
#
# Usage:
#   chmod +x setup-ls-style-modular.zsh
#   ./setup-ls-style-modular.zsh
#
# Optional:
#   ./setup-ls-style-modular.zsh --install
#   ./setup-ls-style-modular.zsh --install --install-font
#   ./setup-ls-style-modular.zsh --module-dir "$HOME/.config/zsh"
#   ./setup-ls-style-modular.zsh --zshrc "$HOME/.zshrc"
#   ./setup-ls-style-modular.zsh --no-icons
#   ./setup-ls-style-modular.zsh --dry-run
...
#
# Managed by setup-ls-style-modular.zsh.
